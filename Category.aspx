                            ...
                            <article class="mix portfolio_category_17 portfolio_category_5  mix_all" style="display: inline-block; opacity: 1;">
                                <div class="image_holder">
                                    <a class="portfolio_link_for_touch" href="#" target="_self">
                                        <span class="image">
                                            <img width="1100" height="825" onerror="imgCatchError(this)" src="<%# Eval("IMG") %>" class="attachment-full wp-post-image" alt="qode interactive strata">
                                        </span>
                                    </a>
                                            ...
                                            <span class="text_inner">
                                                <span class="feature_holder">
                                                    <span class="feature_holder_icons">
                                                        <a class="lightbox qbutton small white" id="TraiNghiemZoom" title="Stockholm Fashion" href="<%# Eval("IMG") %>" data-rel="prettyPhoto[pretty_photo_gallery]" rel="prettyPhoto[pretty_photo_gallery]">zoom</a>
                                                        <a class="preview qbutton small white" href="/trai-nghiem/<%# SystemClass.convertToUnSign2(Eval("NAME").ToString()) %>-ct<%#Eval("ID")%>" target="_self">view</a>
                                                    </span>
                                                </span>
                                            </span>
                                        </span>
                                ...
                                <div class="portfolio_description ">
                                    <h5 class="portfolio_title"><a href="/trai-nghiem/<%# SystemClass.convertToUnSign2(Eval("NAME").ToString()) %>-ct<%#Eval("ID")%>" target="_self"><%# Eval("NAME") %></a></h5>
