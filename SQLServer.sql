...
CREATE TABLE [dbo].[tblProduct](
	ID			INT PRIMARY KEY NOT NULL IDENTITY(1,1),
	GROUPID		INT NULL FOREIGN KEY REFERENCES dbo.tblCategory(ID),
...
CREATE TABLE dbo.tblChatRoom(
	RoomID NVARCHAR(50) PRIMARY KEY NOT NULL DEFAULT NEWID(),
	Name NVARCHAR(50) NOT NULL,
	Email NVARCHAR(50) NOT NULL,
	Phone NVARCHAR(20) NULL,

	--OnlineDate DATETIME NOT NULL DEFAULT(GETDATE()),
	EditDate DATETIME NOT NULL DEFAULT(GETDATE()),
	CreateDate DATETIME NOT NULL DEFAULT(GETDATE())
);

CREATE TABLE dbo.tblChatUser(
	ID NVARCHAR(50) PRIMARY KEY NOT NULL DEFAULT NEWID(),
	RoomID NVARCHAR(50) NOT NULL FOREIGN KEY REFERENCES dbo.tblChatRoom(RoomID),
