<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" MasterPageFile="~/App_Master/System.master" CodeFile="ContactEdit.aspx.cs" Inherits="System_ContactEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="AdminItem">
        ...
        <div class="AdminRightItem">
            <asp:TextBox ID="txtPhone" runat="server" ReadOnly="true" class="AdminTextControl"></asp:TextBox>
        </div>
    </div>
    ...
    <div class="AdminItem">
        ...
        <div class="AdminRightItem">
            <asp:TextBox ID="txtAddress" runat="server" ReadOnly="true" class="AdminTextControl"></asp:TextBox>
        </div>
    </div>
