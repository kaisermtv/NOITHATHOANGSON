<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" MasterPageFile="~/App_Master/System.master" CodeFile="SliderEdit.aspx.cs" Inherits="System_SliderEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="AdminItem" style="display:table">
        ...
        <div class="AdminRightItem" style="display:table">
            <asp:TextBox ID="txtDescribe"  runat="server" class="AdminTextControl" TextMode="MultiLine" style="resize:vertical;height:60px"></asp:TextBox>
        </div>
    </div>
    ...
    <div class="AdminItem">
        ...
        <div class="AdminRightItem">
            ...
            <a href="/System/SliderList.aspx?type=<%= sliderid %>" class="btn btn-default">Thoát</a>
        </div>
    </div>
